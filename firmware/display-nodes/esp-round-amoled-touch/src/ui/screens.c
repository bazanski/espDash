...
void create_screen_main() {
    ...
    lv_obj_set_size(obj, 466, 466);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_arc_set_value(obj, 2500);
        }
        {
            // throttle_arc
            lv_obj_t *obj = lv_arc_create(parent_obj);
            objects.throttle_arc = obj;
            lv_obj_set_pos(obj, 63, 63);
        ...
        }
        {
            ...
            lv_obj_set_pos(obj, 179, 372);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_font(obj, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_label_set_text_static(obj, "5600");
        }
        {
            // status_label
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.status_label = obj;
            lv_obj_set_pos(obj, 121, 394);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_font(obj, &lv_font_montserrat_24, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_label_set_text_static(obj, "Efficiency Monitor");
        }
    }
...
ext_font_desc_t fonts[] = {
    { "Segment7", &ui_font_segment7 },
    { "Segment7_56", &ui_font_segment7_56 },
    { "Segment7_64", &ui_font_segment7_64 },
    { "DSEG_mini_light_20", &ui_font_dseg_mini_light_20 },
    { "DSEG_regular_20", &ui_font_dseg_regular_20 },
    { "DSEG_regular_60", &ui_font_dseg_regular_60 },
    { "DSEG_regular_46", &ui_font_dseg_regular_46 },
