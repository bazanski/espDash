...
* **Node 4:** `esp32-gauge-147.local` (Waveshare ESP32-C6-LCD-1.47 — Universal Telemetry Display)
* **Node 5:** `esp32-shiftlight.local` (Generic ESP32-S3 + I2C OLED — Universal Gauge / Shift Light)
