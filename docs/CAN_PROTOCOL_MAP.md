...
| **Average fuel consumption** | `0x324` | 5 Hz | `d[1]` = km/L ×10. Converted to L/100km: `1000 / d[1]` (or `10000 / d[1]` for x10) | Japanese ECU broadcasts rolling average in km/L x10. E.g. raw 80 = 8.0 km/L = 12.5 L/100km; raw 125 = 12.5 km/L = 8.0 L/100km. Matches instrument cluster average readout exactly | **CONFIRMED** |
| **Instant fuel consumption** | Derived | 50 Hz | `(Q_fuel (L/h) / Speed) × 100` from `0x17C` (RPM/Throttle) + `0x158` (Speed) | High-frequency physical engine model (Civic 1.8L R18). Reacts instantly to throttle and RPM; enables eco-coaching | **CONFIRMED** |
